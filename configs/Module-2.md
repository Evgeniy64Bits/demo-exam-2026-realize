...
>
> chronyc tracking показывает у меня 3 из-за отсутствия ограничений выхода ко внешним NTP-серверам - это нормально. Также расхождение во времени тоже может быть, ничего страшного
