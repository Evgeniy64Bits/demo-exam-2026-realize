...
Ниже представлены IP'шники у ВМ в Proxmox. Реальная нумерация интерфейсов в колледже - ens18, ens19, ens20, у меня такая - ens19, ens20, ens21. C первым модулем такая же история.
