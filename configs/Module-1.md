...
>
> В командном режиме (ESC) клавиша v - посимвольное выделение, V - выделение строки
>
...
# Для каждого региона используется свой прокси-сервер. В домашних условиях прописывать необязательно
ip a
