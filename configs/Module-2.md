...
> 
> Пробрасыаем порт 80 (веб-приложение HQ-SRV), порт 8080 (веб-приложение на BR-SRV) на порт 8080 маршрутизаторов HQ-RTR и BR-RTR, чтобы ISP мог "открыть" эти веб-приложения
>
> Пробрасыаем порт 2026 (подключение ssh к HQ-SRV), порт 2026 (подключение ssh к BR-SRV) на порт 2026 маршрутизаторов HQ-RTR и BR-RTR, чтобы ISP мог подключиться
>
