...
>
> На HQ-SRV создаём каталог nfs на недавно созданном raid массиве. В /etc/export определяем директорию, котоая будет доступна удалённым клиентам, и задаём параметры доступа.
>
