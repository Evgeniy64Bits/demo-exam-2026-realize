...
>
> chronyc tracking показывает у меня 3 из-за отсутствия ограничений выхода ко внешним NTP-серверам - это нормально. В сети колледжа выхода к ним не будет, stratum покажет 5. Также может быть расхождение во времени на колледжском стенде, ничего страшного - это не наша проблема
