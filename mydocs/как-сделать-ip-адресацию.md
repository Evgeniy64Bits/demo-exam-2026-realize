...
В размер подсетей мы задаём в ipmetr количество ip-адресов на хосты, а в условии имеется ввиду общее число ip-адресов (хосты + широковещательный + ip-адрес сети)
...
Мы не вычитаем широковещательный адрес и адрес сети при расчёте через ipmetr
