...
В поле "Исходная сеть" впишем например 192.168.1.0 (третий октет - любой удобный для вас). Маску оставим /24. "Размеры подсетей" - 30, 14 и 6 исходя из условия (вычитаем широковещательный адрес и адрес сети). В размер подсетей мы задаём в ipmetr количество ip-адресов на хосты, а в условии имеется ввиду общее число ip-адресов (хосты + широковещательный + ip-адрес сети)
